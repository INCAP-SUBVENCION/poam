...
<body>
    ...
    <body>
        <nav class="navbar navbar-dark" style="background-color:darkblue;">
            ...
            ?>
                <a class="navbar-brand" href="../promotor/promotor.php"><i class="bi bi-house-door-fill"></i> Inicio</a>
                <div class="dropdown">
        ...
        <section class="section">
            <form name="agregarPoas_1" id="agregarPoas_1" action="javascript: agregarPoa();" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card text-dark">
                        <div class="text-white text-center" style="background-color:navy;">PROYECCION DE INSUMOS</div>
                            <div class="card-body" style="font-size: 12px; background-color:aliceblue;">
                                <div class="row">
                                    <div class="form-group input-group-sm col-sm-3">
