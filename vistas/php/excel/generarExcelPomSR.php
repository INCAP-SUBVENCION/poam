...
t2.reactivo, t2.sifilis, t2.observacion, t8.nombre as estados FROM pom t2
...
WHERE t2.periodo= '$PERIODO' AND t7.subreceptor_id = $SUBRECEPTOR AND t5.persona_id = $PERSONA";
