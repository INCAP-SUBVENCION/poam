...
t2.observacion, t2.supervisado,  CONCAT(p.nombre,' ',p.apellido) AS supervisor, t8.nombre as estados FROM pom t2
...
header('Content-Disposition: attachment; filename=pomOmes.xls');
echo $html;
exit;
?>