<table class="table table-sm table-hover" id="pom_periodo_4" aria-describedby="pom del periodo 3">
    ...
    <tbody style="font-size: 12px;">
        ...
        if ($resp_1 = $enlace->query($sqlp_1)) {
            while ($periodo_4 = $resp_1->fetch_assoc()) { ?>
                <tr>
                    ...
                    <th scope style="font-size: 11px;"><?php if ($periodo_4['estado'] == 'PR01') {
                                                            ...
                                                            echo '<p class="text-warning"> Revisado por M&E </p>';
                                    ...
                                    <li>
                                        <div class="d-grid gap-2">
                                            <button class="dropdown-item" onclick="modalCambiarTodoEstadoPom()">
                                                <em class="bi bi-arrow-clockwise"></em> Enviar todo al supervisor </button>
                                        </div>
                                    </li>
                                    <li>
