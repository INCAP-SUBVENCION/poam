                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group input-group-sm col-sm-2">
                            <select name="cperiodo" id="cperiodo" class="form-select">
                        ...
                        <div class="form-group input-group-sm col-sm-3">
                            <select name="cmunicipio" id="cmunicipio" class="form-control" onchange="obtenerMesPom(); obtenerCantidadPromotor();">
                        ...
                        <div class="form-group input-group-sm col-sm-1">
                            <select name="cmes" id="cmes" class="form-control" onchange="consultaPoa();">
                            </select>
                        </div>
                        <div class="col-md-12">
                            <table class="table table-bordered" aria-describedby="">
                                ...
                                <tbody class="text-center" style="font-size: 11px;" id="resultadoPOA">
                    ...
                    <div class="card-body" style="font-size: 12px; background-color:aliceblue;">
                        <div class="row">
                            <div class="form-group input-group-sm col-sm-4">
                                ...
                                ?>
                                    <input type="hidden" name="promotores" id="promotores" value="<?php echo $promotor['idPromotor']; ?>">
