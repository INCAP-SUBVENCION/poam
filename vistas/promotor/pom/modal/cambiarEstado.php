...
<!-- Modal -->
<div class="modal fade" id="cambiarEstado<?php echo $periodo_1['idPom'];?>" tabindex="-1" aria-labelledby="revisionLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h5 class="modal-title" id="revisionLabel">ENVIAR A REVISION </h5>
      ...
      <div class="modal-body">
        ...
        ?>
          ...
          <!--Datos para cambiar de estado -->
            ...
            <input type="hidden" name="estadoe" id="estadoe" value="ES02">
