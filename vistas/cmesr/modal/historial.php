<div class="modal fade" id="modalHistorialPom" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <table class="table table-hover table-bordered" aria-describedby="">
                    ...
                    <tbody class="text-center bg-light" style="font-size: 11px;">
                        ...
                        <td style="color:darkblue"><strong id="_ainicia"></strong></td>
                        <td style="color:darkblue"><strong id="_afinaliza"></strong></td>
                        <td style="color:darkblue"><strong id="_asupervisado"></strong></td>
                        <td style="color:darkblue"><strong id="_asupervisor"></strong></td>
                        <td style="color:darkgreen"><strong id="_dlugar"></strong></td>
                        <td style="color:darkgreen"><strong id="_dfecha"></strong></td>
                        <td style="color:darkgreen"><strong id="_dinicia"></strong></td>
