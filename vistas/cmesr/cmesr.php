                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2">
                                            <a href="poa/poa.php?id=<?php echo $SUBRECEPTOR; ?>" class="btn btn-sm btn-danger btn-lg"> POA</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2">
                                            <a href="poa/meta.php?id=<?php echo $SUBRECEPTOR; ?>" class="btn btn-sm btn-info btn-lg"> METAS</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
