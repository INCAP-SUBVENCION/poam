...
<div id="omes3" class="table-responsive">
    <table class="table table-hover table-bordered" id="poa_omes_3" aria-describedby="">
        ...
        <tbody class="text-center bg-light" style="font-size: 12px;">
            <?php
            $cont = 1;
            $consult = "SELECT DISTINCT t1.idPoa, t5.nombre as mes, t4.nombre as municipio, t1.nuevo, 
            t1.recurrente, (t1.nuevo + t1.recurrente) AS total, t1.observacion, t2.cnatural, t2.csabor, 
            t2.cfemenino, t2.lubricante, t2.reactivoE, t2.sifilis, t1.estado FROM poa t1
	    ...
	    WHERE t1.subreceptor_id = $SUBRECEPTOR AND t1.periodo = 3 ORDER BY t1.estado";
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php } elseif ($periodo_3['estado'] == 'ES05') { ?>
                                        <li>
                                            <button class="dropdown-item" onclick="modalEditarPoa(<?php echo $SUBRECEPTOR; ?>, 3, <?php echo $periodo_3['idPoa']; ?>)">
                                                <em class="bi bi-pencil-square"></em> Editar </button>
                                        </li>
...
<div id="hsh3" class="table-responsive">
    <table class="table table-hover table-bordered" id="poa_hsh_3" aria-describedby="">
        ...
        t2.pruebaVIH, t2.reactivoE, t2.sifilis, t1.estado FROM poa t1
	    LEFT JOIN insumo t2 ON t2.poa_id = t1.idPoa
	    LEFT JOIN catalogo t3 ON t3.codigo = t1.departamento
	    LEFT JOIN catalogo t4 ON t4.codigo = t1.municipio
	    LEFT JOIN catalogo t5 ON t5.codigo = t1.mes
...
<!--- POM PPL ---->
<div id="ppl3" class="table-responsive">
    <table class="table table-hover table-bordered" id="poa_ppl_3" aria-describedby="">
        <thead class="text-center" style="font-size: 11px;">
            <th scope="">#</th>
            <th scope="">Mes</th>
            <th scope="">Municipio</th>
        ...
        <tfoot>
            ...
            <th scope="">Mes</th>
            <th scope="">Municipio</th>
            <td class="text-center"><strong id="pplnuevos3">0</strong></td>
            <td class="text-center"><strong id="pplrecurrentes3">0</strong></td>
            <td class="text-center"><strong id="ppltotal3">0</strong></td>
            <td class="text-center"><strong id="pplnatural3">0</strong></td>
            <td class="text-center"><strong id="ppllubricantes3">0</strong></td>
            <td class="text-center"><strong id="pplpruebavih3">0</strong></td>
            <td class="text-center"><strong id="pplreactivos3">0</strong></td>
            <td class="text-center"><strong id="pplsifilis3">0</strong></td>
            <th scope="">Observaciones</th>
            <th scope="">Estado</th>
        </tfoot>
    </table>
...
<?php if ($SUBRECEPTOR == '2') { ?>
    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
        <div class="col-sm-6">
            <form action="../../php/excel/generarExcelPoaOmes.php" method="GET">
