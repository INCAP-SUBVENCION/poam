                ...
                <div class="tab-pane fade show active" id="pills-semestre_3" role="tabpanel" aria-labelledby="pills-semestre_3-tab">
                    ...
                    <table class="table table-bordered" aria-describedby="">
                        ...
                        <tbody class="text-center" style="font-size: 12px;">
                            <?php
                            $sqlPoa = "SELECT DISTINCT t4.idPom, CONCAT(t7.nombre,' ',t7.apellido) AS supervisor, t4.periodo, t5.nombre AS mess, t6.nombre AS municipios, t4.lugar, t4.fecha, t1.hora, 
