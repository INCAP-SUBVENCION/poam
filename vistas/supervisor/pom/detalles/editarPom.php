<div class="row">
    <div class="col-md-4">
        <?php
        $sqlEdit = "SELECT DISTINCT t2.idPom, t2.periodo, t3.nombre AS mes, t4.nombre AS municipio, t2.lugar, t2.fecha, t2.horaInicio, t2.horaFin, t5.codigo, CONCAT(t6.nombre, ' ', t6.apellido) as nombres,
        ...
        <form name="agregarPom" id="agregarPom" action="javascript: abc();" method="GET">
            ...
            <input type="hidden" name="descripcion" id="descripcion"
                value="El Plan Operativo Mensual ha sido creado con exito">
                    ...
                    <div class="row">
                        <div class="form-group input-group-sm col-sm-3">
                            ...
                            <input type="text" name="periodo" id="periodo" class="form-control"
                                value="<?php echo $editar['periodo']; ?>" disabled>
                        </div>
                        <div class="form-group input-group-sm col-sm-3">
                            <label class="form-label">Mes:</label>
                            <input type="text" name="nombreMes" id="nombreMes" class="form-control"
                                value="<?php echo $editar['mes']; ?>" disabled>
                        ...
                        <div class="form-group input-group-sm col-sm-6">
                            ...
                            <input type="text" name="nombreMunicipio" id="nombreMunicipio" class="form-control"
                                value="<?php echo $editar['municipio']; ?>" disabled>
                        ...
                        <div class="form-group input-group-sm col-sm-6">
                            ...
                            <input type="date" name="fecha" id="fecha" class="form-control form-control-sm"
                                value="<?php echo $editar['fecha']; ?>" required>
                        </div>
                        <div class="form-group input-group-sm col-sm-3">
                            <label class="form-label">Inicio:</label>
                            <input type="time" name="inicio" id="inicio" class="form-control form-control-sm"
                                value="<?php echo $editar['horaInicio']; ?>" required>
                        </div>
                        <div class="form-group input-group-sm col-sm-3">
                            <label class="form-label">Fin:</label>
                            <input type="time" name="fin" id="fin" class="form-control form-control-sm"
                                value="<?php echo $editar['horaFin']; ?>" required>
                        </div>
                        <div class="form-group input-group-sm col-sm-12">
                            ...
                            <input type="text" name="lugar" id="lugar" class="form-control form-control-sm"
                                style="font-size:12px;" value="<?php echo $editar['lugar']; ?>" required>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="form-group input-group-sm col-sm-4">
                        ...
                        <select name="promotor" id="promotor" class="form-control" style="font-size: 12px;" required>
                            ...
                            <?php
                            $consultaS = "SELECT t3.idPromotor, concat(t2.nombre, t2.apellido) as nombres FROM usuario t1 
                            ...
                            ?>
                            <option value="<?php echo $subreceptor['idPromotor'] ?>">
                                <?php echo $subreceptor['nombres'] ?></option>
                            <?php
                            }
                            $resultadoS->close();
                            ?>
                    ...
                    <div class="form-group input-group-sm col-sm-2">
                        ...
                        <input type="number" min="0.00" step="0.01" name="nuevo" id="nuevo" oninput="sumarPom();"
                            class="form-control form-control-sm" style="font-size: 12px;"
                            value="<?php echo $editar['pNuevo']; ?>" required>
                    </div>
                    <div class="form-group input-group-sm col-sm-2">
                        <label class="form-label">Recurrentes</label>
                        <input type="number" min="0" step="0.01" name="recurrente" id="recurrente" oninput="sumarPom();" class="form-control form-control-sm" style="font-size: 12px;" value="<?php echo $editar['pRecurrente']; ?>" required>
                    </div>
                    <div class="form-group input-group-sm col-sm-2">
                    ...
                    <div class="form-group input-group-sm col-sm-2">
                        ...
                        <input type="text" name="cnatural" id="cnatural" class="form-control form-control-sm"
                            style="color:blue" disabled>
                    </div>
                    <div class="form-group input-group-sm col-sm-2">
                        <label class="form-label">Condon sabor</label>
                        <input type="text" name="csabor" id="csabor" class="form-control form-control-sm"
                            style="color:blue" disabled>
                    </div>
                    <div class="form-group input-group-sm col-sm-2">
                        <label class="form-label">Condon femenino</label>
                        <input type="text" name="cfemenino" id="cfemenino" class="form-control form-control-sm"
                            style="color:blue" disabled>
                    </div>
                    <div class="form-group input-group-sm col-sm-2">
                        <label class="form-label">Lubricante</label>
                        <input type="text" name="lubricante" id="lubricante" class="form-control form-control-sm"
                            style="color:blue" disabled>
                    </div>
                    <div class="form-group input-group-sm col-sm-2">
                        <label class="form-label">Prueba VIH</label>
                        <input type="text" name="pruebaVIH" id="pruebaVIH" class="form-control form-control-sm"
                            style="color:blue" disabled>
                    </div>
                    <div class="form-group input-group-sm col-sm-2">
                        <label class="form-label">Autoprueba VIH</label>
                        <input type="text" name="autoPrueba" id="autoPrueba" class="form-control form-control-sm"
                            style="color:blue" disabled>
                    </div>
                    <div class="form-group input-group-sm col-sm-2">
                        ...
                        <div class="position-relative">
                            <input type="text" name="reactivoEs" id="reactivoEs" class="form-control form-control-sm"
                                style="color:blue" disabled>
                    ...
                    <div class="form-group input-group-sm col-sm-2">
                        ...
                        <input type="text" name="sifilis" id="sifilis" class="form-control form-control-sm"
                            style="color:blue" disabled>
                    </div>
                    <div class="form-group input-group-sm col-sm-5">
                        ...
                        <input type="text" name="observacion" id="observacion" class="form-control form-control-sm"
                            value="<?php echo $editar['observacion']; ?>">
                    </div>
                    <div class="form-group input-group-sm col-sm-3">
                        <br>
                        ...
                        <button type="reset" class="btn btn-outline-danger"> <em class="bi bi-x-square-fill"></em>
                            Cancelar</button>
                    </div>
                </div>
            </div>
