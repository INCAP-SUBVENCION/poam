                            ...
                            <div class="col-md-4">
                                <div class="card text-dark bg-info mb-4" style="max-width: 20rem;">
                                    <div class="text-center">
                                        <img src="../../assets/images/vihinvertido.png" width="55" alt="...">
                                    </div>
                                    <h5 class="card-title text-center text-white"><?php echo $fila['codigo']; ?></h5>
                                    <div class="card-body">
                                        <h6 class="text-center"> <?php echo $fila['nombre']; ?> </h6>
                                        <ul class="list-group list-group-flush">
                                            <a class="list-group-item" href="supervision/supervision.php?id=<?php echo $fila['idSubreceptor'] ?>"><i class="bi bi-binoculars-fill"></i> Supervisiones </a>
