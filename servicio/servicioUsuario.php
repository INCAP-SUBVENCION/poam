...
if ($accion == "agregarUsuario") {
    ...
    if(mysqli_num_rows($_duplicado)<=0){
        echo "Duplicado";
    } else {
        $sql = "CALL agregarUsuario($documento, '$numero', '$pnombre', '$snombre', '$papellido', '$sapellido', '$direccion', '$telefono',
        '$correo', '$rol', $subreceptor, $editar, $agregar, $usuarios, $poas, $poms, $sub, $promotores, $catalogos, $resumen, $coberturas)";
